...
ALLOWED_HOSTS = ['Ayushthakur741.pythonanywhere.com', 'localhost', '127.0.0.1']
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'travel_booking_db'),
        'USER': os.environ.get('DB_USER', 'travelBooking_user'),
